...
static STEP_FLAG s_flags[] =
{
	SF_STEP, SF_STEP, SF_STEP, SF_STEP, SF_OVER, SF_STEP, SF_STEP, SF_STEP,
	SF_OVER, SF_STEP, SF_OVER, SF_STEP, SF_STEP, SF_STEP, SF_STEP, SF_STEP,
	SF_OVER, SF_STEP, SF_STEP, SF_STEP, SF_OVER, SF_STEP, SF_STEP, SF_STEP,
	SF_STEP, SF_OVER, SF_STEP, SF_OVER, SF_STEP, SF_STEP, SF_STEP, SF_STEP,
	SF_OVER, SF_STEP, SF_OVER, SF_STEP, SF_STEP, SF_STEP, SF_OVER, SF_OVER,
	SF_STEP, SF_STEP, SF_STEP, SF_STEP, SF_STEP, SF_STEP, SF_OUT , SF_OUT ,
	SF_OUT , SF_STEP, SF_STEP, SF_STEP, SF_STEP, SF_STEP, SF_STEP, SF_STEP,
	SF_STEP, SF_STEP, SF_STEP, SF_OVER, SF_STEP, SF_STEP, SF_STEP, SF_STEP,
	SF_STEP, SF_STEP, SF_STEP, SF_STEP, SF_STEP
};
 ...
 ****************************************************************************/
const string& cpu_disassemble_z80(uint16_t pc, const uint8_t *mem, unsigned& length, STEP_FLAG& flag)
{
	const z80dasm *d;
	const char *src, *ixy;
	char* dst = buffer;
	...
	case 0xdd:
		...
		if( op1 == 0xcb )
		{
			offset = (int8_t) mem[pos++];
			op1 = mem[pos++]; /* fourth byte from opbase.ram! */
