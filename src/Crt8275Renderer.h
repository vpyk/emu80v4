...
class Crt8275Renderer : public TextCrtRenderer
{
    ...
    protected:
        virtual const uint8_t* getCurFontPtr(bool gpa0, bool gpa1, bool hglt) {return nullptr;};
        virtual const uint8_t* getAltFontPtr(bool gpa0, bool gpa1, bool hglt) {return nullptr;};
        virtual uint32_t getCurFgColor(bool gpa0, bool gpa1, bool hglt) = 0;
        virtual uint32_t getCurBgColor(bool gpa0, bool gpa1, bool hglt) {return 0x000000;};
