...
REG ADD HKCU\Software\Classes\Emu80.rk\shell\open\command /t REG_SZ /d "\"%EXE%\" \"%%1"\" /f 
...
REG ADD HKCU\Software\Classes\Emu80.rkr\shell\open\command /t REG_SZ /d "\"%EXE%\" \"%%1"\" /f 
...
REG ADD HKCU\Software\Classes\Emu80.gam\shell\open\command /t REG_SZ /d "\"%EXE%\" \"%%1"\" /f 
...
REG ADD HKCU\Software\Classes\Emu80.rka\shell\open\command /t REG_SZ /d "\"%EXE%\" \"%%1"\" /f 
...
REG ADD HKCU\Software\Classes\Emu80.rkp\shell\open\command /t REG_SZ /d "\"%EXE%\" \"%%1"\" /f 
...
REG ADD HKCU\Software\Classes\Emu80.rkm\shell\open\command /t REG_SZ /d "\"%EXE%\" \"%%1"\" /f 
...
REG ADD HKCU\Software\Classes\Emu80.rk8\shell\open\command /t REG_SZ /d "\"%EXE%\" \"%%1"\" /f 
...
REG ADD HKCU\Software\Classes\Emu80.rku\shell\open\command /t REG_SZ /d "\"%EXE%\" \"%%1"\" /f 
...
REG ADD HKCU\Software\Classes\Emu80.rks\shell\open\command /t REG_SZ /d "\"%EXE%\" \"%%1"\" /f 
...
REG ADD HKCU\Software\Classes\Emu80.rko\shell\open\command /t REG_SZ /d "\"%EXE%\" \"%%1"\" /f 
...
REG ADD HKCU\Software\Classes\Emu80.bru\shell\open\command /t REG_SZ /d "\"%EXE%\" \"%%1"\" /f 
...
REG ADD HKCU\Software\Classes\Emu80.ord\shell\open\command /t REG_SZ /d "\"%EXE%\" \"%%1"\" /f 
...
REG ADD HKCU\Software\Classes\Emu80.cpu\shell\open\command /t REG_SZ /d "\"%EXE%\" \"%%1"\" /f 
